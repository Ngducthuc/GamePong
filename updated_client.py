...
client_socket.settimeout(1)  # Timeout for non-blocking socket behavior
...
def main():
    ...
    while running:
        ...
        pygame.draw.rect(screen, WHITE, (0, HEIGHT // 2 - goal_height // 2, goal_width, goal_height))  # Left goal
        pygame.draw.rect(screen, WHITE, (WIDTH - goal_width, HEIGHT // 2 - goal_height // 2, goal_width, goal_height))  # Right goal
